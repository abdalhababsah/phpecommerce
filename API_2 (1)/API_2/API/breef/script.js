...
fetchProducts();
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function updatePriceRange() {
            ...
            minPrice.textContent = `Min Price: $${minPriceValue}`;
            maxPrice.textContent = `Max Price: $${maxPriceValue}`;
    
            products.forEach(product => {
                const productPrice = parseFloat(product.querySelector('.des h4').textContent.slice(2));
    
                if (productPrice >= minValue && productPrice <= maxPriceValue) {
    ...
    let tocartHome = document.getElementById('tocartHome');
    ...
    if (isLoggedIn === 'true') {
        ...
        loginButtonNav.addEventListener('click', (e) => {
         ...
         tocartHome.addEventListener('click', function () {
